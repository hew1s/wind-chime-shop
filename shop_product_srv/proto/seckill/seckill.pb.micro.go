...
type SecKillsService interface {
	...
	FrontSecKills(ctx context.Context, in *FrontSecKillRequest, opts ...client.CallOption) (*FrontSecKillResponse, error)
	FrontSeckillDetail(ctx context.Context, in *DelSecKillRequest, opts ...client.CallOption) (*FrontSeckillDetailResponse, error)
}
...
func (c *secKillsService) FrontSecKills(ctx context.Context, in *FrontSecKillRequest, opts ...client.CallOption) (*FrontSecKillResponse, error) {
	req := c.c.NewRequest(c.name, "SecKills.FrontSecKills", in)
...
func (c *secKillsService) FrontSeckillDetail(ctx context.Context, in *DelSecKillRequest, opts ...client.CallOption) (*FrontSeckillDetailResponse, error) {
...
type SecKillsHandler interface {
	...
	FrontSecKills(context.Context, *FrontSecKillRequest, *FrontSecKillResponse) error
	FrontSeckillDetail(context.Context, *DelSecKillRequest, *FrontSeckillDetailResponse) error
}
...
func RegisterSecKillsHandler(s server.Server, hdlr SecKillsHandler, opts ...server.HandlerOption) error {
	type secKills interface {
		...
		FrontSecKills(ctx context.Context, in *FrontSecKillRequest, out *FrontSecKillResponse) error
		FrontSeckillDetail(ctx context.Context, in *DelSecKillRequest, out *FrontSeckillDetailResponse) error
	}
...
func (h *secKillsHandler) FrontSecKills(ctx context.Context, in *FrontSecKillRequest, out *FrontSecKillResponse) error {
	return h.SecKillsHandler.FrontSecKills(ctx, in, out)
}

func (h *secKillsHandler) FrontSeckillDetail(ctx context.Context, in *DelSecKillRequest, out *FrontSeckillDetailResponse) error {
